...
PLANS = {
    ...
    "emirati":      ("Emirati Freedom", "250", "", "Unlimited high-speed", "Unlimited local", "—", "VIP", False,
...
<body>
  ...
  <section class="hero"><div class="wrap hero-inner"><span class="eyebrow">⚡ Official e&amp; Partner · Authorized Etisalat Dealer</span><h1>@@H1@@</h1><p class="lead">@@LEAD@@</p><div class="hero-cta"><a href="/#finder" class="btn btn-red btn-lg">Find my plan in 60s →</a><a href="@@HERO_WA@@" target="_blank" rel="noopener noreferrer" class="btn btn-ghost btn-lg">Ask on WhatsApp</a></div><div class="trust-row"><span>✓ Same-day delivery</span><span>✓ Free VIP number</span><span>✓ All UAE</span></div></div></section>
